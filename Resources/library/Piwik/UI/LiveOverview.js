 ...
 *
 * @example
 * var overview = Piwik.UI.createLiveOverview({title: 'Last 30 Minutes', actions: 15, visits: 2});
 * var row      = overview.getRow();
 * overview.refresh({actions: 20, visits: 4});
 *
 * @augments Piwik.UI.View
 */
Piwik.UI.LiveOverview = function () {
 ...
 */
Piwik.UI.LiveOverview.prototype = Piwik.require('UI/View');