 ...
 * Piwik.App.Session.get('period');           // fetch the value of the key period, stored in the session
 *
 * @static
...
Piwik.App.Session = new function () {
     ...
     *
     * @example
     * Piwik.App.Session.get('period', 'day');
     *
    ...
    this.get = function (key, defaultValue) {
        ...
        Piwik.Log.debug(key, 'Piwik.App.Session::get');
     ...
     *
     * @example
     * Piwik.App.Session.set('period', 'year');
     * Piwik.App.Session.get('period');  // = 'year'
     *
     * @type null
     * @throws {Error} In case of a missing key
     */
    this.set = function (key, value) {
        ...
        Piwik.Log.debug(key, 'Piwik.App.Session::set');
    ...
    this.remove = function (key) {
        ...
        Piwik.Log.debug(key, 'Piwik.App.Session::remove');
