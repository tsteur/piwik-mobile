 ...
 * pool.send(function () {});
 */
Piwik.Network.RequestPool = function () {
     ...
     *
     * Array (
     *    [int] => <An instance of Piwik.Network.HttpRequest>
     * )
     * 
     * @type Array
     */
     ...
     * @type null
     *
     * @todo create a setCallback(context, onAllResultsReceivedCallback) method, see Piwik.Network.HttpRequest#setCallback
     *       or fire an event .fireEvent('onAllResultsReceivedCallback')
     * @todo rename 'onAllResultsReceivedCallback' to 'onload'?
     */
    this.send = function (onAllResultsReceivedCallback) {
