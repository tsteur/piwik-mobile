...
for I in `find ../Resources/ -name "*.js" -type f` ; 
 ...
 do echo $I;
 java -jar closurecompiler/compiler.jar  --compilation_level SIMPLE_OPTIMIZATIONS --logging_level=1000 --third_party=true --warning_level=quiet --charset utf-8 --define='config.logEnabled=false,config.profileEnabled=false,config.debugging=false' --js $I --js_output_file $I"_minify.js"
