...
// in simulator we redefine to format for PiwikMobile Developer console
...
{\
	NSString * exceptionName = [@"org.piwikmobile." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.piwikmobile";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIPiwikMobileNativeItemNone = -1, 
	UIPiwikMobileNativeItemSpinner = -2,
	UIPiwikMobileNativeItemProgressBar = -3,
	
	UIPiwikMobileNativeItemSlider = -4,
	UIPiwikMobileNativeItemSwitch = -5,
	UIPiwikMobileNativeItemMultiButton = -6,
	UIPiwikMobileNativeItemSegmented = -7,
	
	UIPiwikMobileNativeItemTextView = -8,
	UIPiwikMobileNativeItemTextField = -9,
	UIPiwikMobileNativeItemSearchBar = -10,
	
	UIPiwikMobileNativeItemPicker = -11,
	UIPiwikMobileNativeItemDatePicker = -12,
	
	UIPiwikMobileNativeItemInfoLight = -13,
	UIPiwikMobileNativeItemInfoDark = -14,
	
	UIPiwikMobileNativeItemDisclosure = -15,
	
	UIPiwikMobileNativeItemContactAdd = -16
};
